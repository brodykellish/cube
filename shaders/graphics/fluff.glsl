...
// FIXED: Disabled HIGH_QUALITY mode due to GLSL 1.20 incompatibility (bit operations not supported)
//#if HW_PERFORMANCE==0
//#define HIGH_QUALITY
//#else
//#define HIGH_QUALITY
//#endif
// #define HIGH_QUALITY 0  // Commented out to use simple texture path
...
// Use simple texture path (GLSL 1.20 compatible)
