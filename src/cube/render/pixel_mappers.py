...
class CubePixelMapper(PixelMapper):
    ...
    def __init__(self, face_width: int=None, face_height: int=None, num_panels: int=6, face_distance: float=5.0, face_size: int=None):
        """
    ...
    def get_render_specs(self) -> List[RenderSpec]:
        return [RenderSpec(self.face_width, self.face_height, None) for _ in self.active_faces]
