...
# Internal filename: /Users/brody/k/nye/cube/src/cube/shader/template_string_format.py
# Bytecode version: 3.12.0rc2 (3531)
# Source timestamp: 2025-12-03 02:11:42 UTC (1764727902)
...
class StringFormatTemplateEngine:
    ...
    def create_shader(self, template_name: str, **params) -> str:
        ...
        with open(template_path) as f:
            template = f.read()
        includes = {f'INCLUDE_{name.upper()}': code for name, code in self.snippets.items()}
