...
# Internal filename: /Users/brody/k/nye/cube/src/cube/shader/input_sources.py
# Bytecode version: 3.12.0rc2 (3531)
# Source timestamp: 2025-12-01 09:55:40 UTC (1764582940)
...
class KeyboardInput(InputSource):
    ...
    def __init__(self):
        ...
        self.input_state = {'left': 0.0, 'right': 0.0, 'up': 0.0, 'down': 0.0, 'forward': 0.0, 'backward': 0.0}
...
class AudioFileInput(InputSource):
    ...
    def __init__(self, audio_path: str, bpm: Optional[float] = None):
        ...
        try:
            ...
            # Optional dependency: fall back to synthetic beat if missing
            self.processor = None
            self.has_audio = False
        except Exception as e:
            # If initialization fails for any reason, log and fall back
            print(f'Warning: Could not initialize audio processor for {self.audio_path}: {e}')
            self.processor = None
            self.has_audio = False
...
class MicrophoneInput(InputSource):
    ...
    def __init__(self, device_index: Optional[int] = None):
        ...
        try:
            ...
            # Optional dependency: keep stub behavior if not available
            self.pyaudio = None
            self.has_audio = False
        ...
        if self.has_audio:
            # Placeholder until real-time analysis is implemented
...
class InputManager:
    ...
    def remove_source(self, source: InputSource):
        """
