#!/usr/bin/python3
"""
Display a series of 64x64 PNG images as fast as possible
...
geometry = piomatter.Geometry(width=64, height=64, n_addr_lines=5, rotation=piomatter.Orientation.Normal)
